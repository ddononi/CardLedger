 ...
 * 카드사별 내역 조회
 */
public class MonthListActivity extends MyActivity {
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		setContentView(R.layout.month_list_layout);
		...
		spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(final AdapterView<?> parent,
				...
				list = getList(card);
				if (list != null) {
					la = new ListAdapter(MonthListActivity.this, list,
							R.layout.list_item_layout);
					lv.setAdapter(la);
					countTv.setText("사용 내역 건수 : " + list.size());
				} else {
					Toast.makeText(MonthListActivity.this, "사용내역이 없습니다.",
